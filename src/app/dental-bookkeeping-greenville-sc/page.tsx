...
export const metadata: Metadata = {
  title: 'Dental Bookkeeping Greenville, SC - Crown Ledger Solutions',
  description: 'Specialized dental bookkeeping services in Greenville, SC. Expert financial management for dental practices in the Upstate region.',
  openGraph: {
    title: 'Dental Bookkeeping Greenville, SC - Crown Ledger Solutions',
    description: 'Professional dental bookkeeping services in Greenville, SC. Financial clarity for dental practices.',
  },
}
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-primary-600">Greenville, SC</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8">
              Financial clarity for dental practices in the Greenville area
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
                Serving Greenville Dental Practices
              </h2>
              <div className="prose prose-lg text-gray-600 max-w-3xl mx-auto">
                <p className="mb-4">
                  Greenville, South Carolina, is home to a thriving dental community serving the 
                  growing Upstate region. As dental practices in Greenville continue to expand and 
                  serve more patients, the need for specialized financial management becomes increasingly 
                  important. We understand the unique challenges that Greenville dental practices face.
                </p>
                <p>
                  Our specialized dental bookkeeping services are designed specifically for practices 
                  like yours in Greenville. We understand the local market dynamics, including the 
                  cost of living considerations that affect payroll management and the competitive 
                  landscape that impacts pricing strategies.
                </p>
              </div>
            </div>
            ...
            <div className="bg-primary-50 rounded-xl p-8 mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
                Why Greenville Dentists Choose Us
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">Local Market Expertise</h3>
                  <p className="text-gray-600">
                    We understand Greenville's business environment, local regulations, and the unique 
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">Growth-Focused Approach</h3>
                  <p className="text-gray-600">
                    We don't just record transactions—we provide insights that help you 
                    manage rapid growth and make informed decisions about your Greenville practice.
                  </p>
                </div>
                <div>
